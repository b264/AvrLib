...
struct Timer0Info {
    ...
    static void setPrescaler(prescaler_t p) {
    	switch(p) {
    	case ExtPrescaler::_1    : ( CS00 | ~CS01 | ~CS02).apply(); break;
    	case ExtPrescaler::_8    : (~CS00 |  CS01 | ~CS02).apply(); break;
    	case ExtPrescaler::_64   : ( CS00 |  CS01 | ~CS02).apply(); break;
    	case ExtPrescaler::_256  : (~CS00 | ~CS01 |  CS02).apply(); break;
    	case ExtPrescaler::_1024 : ( CS00 | ~CS01 |  CS02).apply(); break;
    	}
    }
...
struct Timer1Info {
    ...
    static void setPrescaler(prescaler_t p) {
    	switch(p) {
    	case ExtPrescaler::_1    : ( CS10 | ~CS11 | ~CS12).apply(); break;
    	case ExtPrescaler::_8    : (~CS10 |  CS11 | ~CS12).apply(); break;
    	case ExtPrescaler::_64   : ( CS10 |  CS11 | ~CS12).apply(); break;
    	case ExtPrescaler::_256  : (~CS10 | ~CS11 |  CS12).apply(); break;
    	case ExtPrescaler::_1024 : ( CS10 | ~CS11 |  CS12).apply(); break;
    	}
    }
...
struct Timer2Info {
    ...
    static void setPrescaler(prescaler_t p) {
    	switch(p) {
    	case IntPrescaler::_1    : ( CS20 | ~CS21 | ~CS22).apply(); break;
    	case IntPrescaler::_8    : (~CS20 |  CS21 | ~CS22).apply(); break;
    	case IntPrescaler::_32   : ( CS20 |  CS21 | ~CS22).apply(); break;
    	case IntPrescaler::_64   : (~CS20 | ~CS21 |  CS22).apply(); break;
    	case IntPrescaler::_128  : ( CS20 | ~CS21 |  CS22).apply(); break;
    	case IntPrescaler::_256  : (~CS20 |  CS21 |  CS22).apply(); break;
    	case IntPrescaler::_1024 : ( CS20 |  CS21 |  CS22).apply(); break;
    	}
    }
